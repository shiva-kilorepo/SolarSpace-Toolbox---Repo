...
NOTES:
Do not use this version - WIP; use NorthingAdjPOA.pyt
"""
...
class ATINorthingAdj(object):
    def __init__(self):
        self.label = "Adj Northing ATI"
    ...
    def execute(self, parameters, messages):
        ...
        # gearboxSQL = parameters[2].valueAsText 
        ...
        # # Create a feature class of the gearbox piles
        # gearboxPiles = arcpy.analysis.Select(pilesAdj, "gearboxPiles", gearboxSQL)
...
# def dAdjm(distGear, deltaG, slopeRad):
    # if distGear == 0:
        # return 0
    # else: 
        # return distGear * math.cos(slopeRad) - deltaG
# """
